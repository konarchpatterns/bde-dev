    ...
    <div class="row">
                                      ...
                                      <div class="col-12">
                                            <div class="">
                                              <!--   <p class="card-category">totalassigncompanydata</p> -->
                                                <h4 class="card-title">Total Assigned</h4>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="icon-big text-center icon-warning">
                                                {{$totalassigncompanydata}}
                                            </div>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-5">
             <div class="row">
               <div class="col-sm-8">
                <h5 align="right"><b>{{$user->name}} Reports</b></h5>
               </div> 
               <div class="col-sm-4">
                     <select class="selectdispositionday"><option>Life Time</option><option selected="">Today</option><option>Yesterday</option><option>Select Date</option><option>Last 7 Days</option><option>Last 30 Days</option><option>Custom</option></select>
                </div>
             </div>
