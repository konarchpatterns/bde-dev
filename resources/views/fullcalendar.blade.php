                ...
                <div class="modal fade right" id="eventDialog" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                         ...
                         <form action="{{route('event.store')}}" method="post" class="formclass" onsubmit="return checkeventForm(this);">
                             @csrf
                        <div class="row">
                            ...
                            <input id='title' name='title' class="form-control mt-0 field eventtext" type="text" value=""></input>
                             ...
                             <div class="col-md-3 pl-1">
                                 <label>Time Zone:</label>
                                     <input id='timezoneid' name='time_zone' class="form-control mt-0 eventtext"
                       ...
                       <!--   <lable id="addguest" class="btn btn-sm mt-1 btn-warning" > + </lable> -->
                           ...
                           <div class="row float-right">
                                ...
                                <div class="col-md-2 ">
                                   ...
                                   <!--  <button class="btn btn-fill btn-primary" name="myButton" id="submiteventbutton">Submit</button> -->
                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-content">
                           <!--  <div class="modal-header"> -->
                            ...
                            <div class="modal-body">
                           <form action="{{route('event.update')}}" method="post" class="updateform" onsubmit="return checkupdateeventForm(this);">
                        ...
                        <!--  <lable id="addguestupdate" class="btn btn-sm mt-1 btn-warning" > + </lable> -->
                           ...
                           <div class="row">
                             <div class="col-md-12">
                                ...
                                <!--  <button id="updateeventid" class="btn btn-fill  btn-primary rightdiv">Update</button> -->
                                <a id="delteevent" class="btn btn btn-danger btn-fill rightdiv mr-2" name="mylink" style="color: white" value="" onclick="Deleteevent(this)">Delete</a> 
...
// });
        ...
        if($("#e2").is(":checked") == false && $("#e1").is(":checked") == false ){
               ...
               // return ['all', event.create_user_id].indexOf($('#school_selector').val()) >= 0
          
          
         
       ///console.log(event.type  =='task' || event.type  =='event' );
               // return ['all', event.type].indexOf($('#typeselector').val()) >= 0 
...
function deleteguestemail(obj,pp){
    ...
    swal({
                ...
                $.ajax({
                  url:"{{route('event.attendemaildelete')}}",
                  type:'post',
...
//show company table in modal 
  $(function () {
     var table = $('#companyrecords').DataTable({
        ...
        ajax: "{{ route('company.anydata',['id'=>'All']) }}",
        columnDefs: [
