...
$(document).on("focusout", ".emailid", function(){  
 ...
 //takecompany name
 $( document ).ready(function(){
   $('#websiteid').on("focusout",function(){
       var websiteval=$('#websiteid').val();
       if(websiteval == ""){
                ...
                data: {
                 ...
                 console.log(data);   
                  if(data != ""){
                         ...
                         swal({
                                          icon: 'info',
                                          title: 'Website name already exist',
                                          // text: ' to continue with '+data+'',
