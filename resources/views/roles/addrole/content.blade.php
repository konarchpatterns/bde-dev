<form action="{{ route('role.store') }}" method="post">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-9">
                <h5><a href="{{ route('role.index') }}"><b>Roles</b></a> <i class="fa fa-angle-double-right"></i>Create
                </h5>
            </div>
            <div class="col-md-3">
                <a href="{{ route('role.index') }}" class=" btn btn-danger btn-outline rightdiv">Cancel</a>
                <button class="btn btn-primary btn-outline rightdiv mr-2">save</button>
            </div>
        </div>
        @if ($errors->any())
            ...
            <div class="col-md-12">
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <h5 align="center" class="rounded pt-2 pb-2 ts"><b>Permission</b></h5>
