...
<div class="row">
        <div class="col-md-3">
          <h5>Unassigned Click Clients</h5>
        ...
        <div class="col-md-6">
           @permission('edit.company.assign.user')
             ...
             <a class="btn btn-success btn-sm btn-outline rightdiv mr-2" href="{{route('clickclients.clickshowassigncompany')}}"  data-toggle="tooltip" data-placement="bottom" title="Assigned Accounts" >AA</a>
             <a class="btn btn-success btn-sm btn-outline rightdiv mr-2" href="{{route('clients.index')}}"data-toggle="tooltip" data-placement="bottom" title="Show All Accounts" >SAA</a>
            @endpermission
           ...
           <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline rightdiv mr-2 filternewdialaccont"   data-toggle="tooltip" data-placement="bottom" title="Dialed Accounts"  value="DA">DA</a>
            ...
            <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline active rightdiv mr-2 filternewdialaccont"   data-toggle="tooltip" data-placement="bottom" title="All Accounts"  value="ALL">ALL</a>
...
var table =   $('#comp-table').DataTable({
        ...
        ajax: "{{ route('clickclients.unassignedanydata',['id'=>'ALL']) }}",
...
$('.filternewdialaccont').on('click', function(){
  ...
  var new_url = "{{ route('clickclients.unassignedanydata',':id') }}";
