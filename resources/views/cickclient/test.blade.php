    ...
    <div class="row">
        ...
        <div class="col-md-6">
            @permission('edit.company.assign.user')
                ...
                <a class="btn btn-success btn-sm btn-outline rightdiv mr-2"
                    href="{{ route('clickclients.clickshowunassigncompany') }}" data-toggle="tooltip" data-placement="bottom"
                    title="Unassigned Accounts">
                    UA
                </a>
                <a class="btn btn-success btn-sm btn-outline rightdiv mr-2"
                    href="{{ route('clickclients.clickshowassigncompany') }}" data-toggle="tooltip" data-placement="bottom"
            ...
            <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline rightdiv mr-2 filternewdialaccont"
                data-toggle="tooltip" data-placement="bottom" title="Dialed Accounts" value="DA">DA</a>
            <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline rightdiv mr-2 filternewdialaccont"
                data-toggle="tooltip" data-placement="bottom" title="New Accounts" value="NA">NA</a>
            <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline active rightdiv mr-2 filternewdialaccont"
                data-toggle="tooltip" data-placement="bottom" title="All Accounts" value="ALL">ALL</a>
            <a href="javascript:void(0)" class="btn btn-warning btn-sm btn-outline rightdiv mr-2 filternewdialaccont"
    ...
    <div class="table-wrapper-scroll-y my-custom-scrollbar table-responsive  mt-2">
        ...
        <table id="comp-table" class="table table-bordered  mb-0" style="width:100%">
            ...
            <tr role="row" class="odd">
                ...
                @foreach($apiData['companyid'] as $key=>$val)
                @foreach($apiData['companyid'][$key] as $keys=>$vals)
               
                <td class=" checkclass dt-center">
                    <input type="checkbox" name="checkbox1[]" class="checkboxid" value="2019051693"></td>
                    <td class=" idclass1 dt-body dt-center ">
                        <a href="http://www.click.com/clients/1762/show" class="test" title="{{$key}}"
                         data-toggle="tooltip" target="_blank">{{$key}}</a></td><td class=" dt-center">
                             <span onclick="orderinformation({{ltrim($key,'CO')}}	)" class="test" data-toggle="tooltip"
                              title="Proforma Resources">{{$vals['company_name']}}</span></td><td class="dt-center sorting_1">
                                  <span>{{$vals['name']}}</span></td><td class=" dt-center">
                                      <span onclick="redirectToPhoneURL(7073109393,2019051693)">{{$vals['phone']}}</span><br>
                                    </td>
                                      <td class=" dt-center">{{$vals['state']}}</td><td class=" dt-center">{{$vals['country']}}</td><td class=" dt-center">{{$vals['timezone']}}</td>
                                      <td class=" dt-center"><span onclick="assignSingleUser(2019051693)" class="test" 
                                      data-toggle="tooltip" title="Karan Khatwani">{{$vals['user']}}</span></td>
                                      <td class=" dt-center">{{$vals['assigned_by']}}</td><td class=" dt-center"><span class="filename " onclick="lastdispositiondetail(2019051693)" data-html="true" data-toggle="tooltip" title="10-05-2022 02:49:28<br/>Answering Machine">
            {{$vals['disposition']}}</span></td></tr>
    ...
    <script>
        $(function() {
            ...
            var table = $('#comp-table').DataTable({
                ...
                ajax: "{{ route('clickclients.anydata', ['id' => 'ALL']) }}",
