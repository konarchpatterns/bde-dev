    ...
    <div class="row">
        ...
        <div class="col-md-6">
            @permission('edit.company.assign.user')
                <a href="javascript:void(0)" id="assignuser" class="btn btn-info btn-sm btn-outline rightdiv mr-2">Assign
                    User</a>
                <a class="btn btn-success btn-sm btn-outline rightdiv mr-2"
                    ...
                    title="Unassigned Accounts">UA</a>
                <a class="btn btn-success btn-sm btn-outline rightdiv mr-2" href="{{ route('clients.index') }}"
                    data-toggle="tooltip" data-placement="bottom" title="Show All Accounts">SAA</a>
            @endpermission
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" value="Existing Customer"
                                                name="optradio"> Existing Customer
                                        </label>
                                    </div>
                                </td>
                            </tr>
    ...
    <script>
        $(function() {
            ...
            var table = $('#comp-table').DataTable({
                ...
                ajax: "{{ route('clickclients.assignedanydata', ['id' => 'ALL']) }}",
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, full, meta) {
                            ...
                            data = '<a href="http://www.click.com/clients/' + full.id +
                                '/show"  class="test" data-toggle="tooltip" title="' + data +
        ...
        $('.filternewdialaccont').on('click', function() {
            ...
            var new_url = "{{ route('clickclients.assignedanydata', ':id') }}";
