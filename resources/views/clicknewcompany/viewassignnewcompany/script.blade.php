...
var table =   $('#comp-table').DataTable({
        ...
        ajax: "{{ route('clickclients.assignclicknewcompanyanydata',['id'=>'ALL^Last 3 Months']) }}",
...
// http://www.click.com/clients/2682/show
...
$(document).on("click", "#delsession", function(){
        ...
        var table=$('#comp-table').DataTable();
          ...
          //window.location.href = "{{ route('clickclients.assignclicknewcompanyanydata',['id'=>'ALL^Last 3 Months']) }}";
});
...
$('.filternewdialaccont').on('click', function(){
  ...
  var selectedvalue=filter_value+'^'+$('#newcompanyselectionid').val()+'^'+selecteddate;
    ...
    var new_url = "{{ route('clickclients.assignclicknewcompanyanydata',':id') }}";
