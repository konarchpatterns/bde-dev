<div class="row">
        ...
        <div class="col-md-3" align="center">
          ...
          <select class="" id="newcompanyselectionid" onselect="changeFunc()">
          <option value="Last 3 Months" class="newcompanyselectionclass">Last 3 Months</option>
          <option class="newcompanyselectionclass" value="Current Month">Current Month</option>
          <option class="newcompanyselectionclass" value="Last 6 Months">Last 6 Months</option>
          <option class="newcompanyselectionclass" value="Select Month">Select Month</option></select>
        </div>
        ...
        <div class="col-md-6">
           @permission('edit.company.assign.user')
            <a href="javascript:void(0)" id="assignuser" class="btn btn-info btn-sm btn-outline rightdiv mr-2">Assign User</a> 
              <a class="btn btn-success btn-sm btn-outline rightdiv mr-2" href="{{route('clickclients.unassignclicknewcompany')}}" data-toggle="tooltip" data-placement="bottom" title="Unassigned Accounts">UA</a>
