 <script type="text/javascript">
  ...
  $(document).ready(function () {
	...
	$("#addemail").on("click",function (e) {
      ...
      if(a != 1){
 			$("#emailtextbox").append('<div class="input-group input-group-unstyled"><input type="email"  class="form-control emailid" id="email['+i+']" placeholder="" name="email[]" value="" required=""><select name="email_type[]" id="email_type[]" class="mt-2"><option value="Home">Home</option><option value="Work">Work</option></select><a href="#" class="remove_emailfield1 btn1 mt-2">X</a></div>');
